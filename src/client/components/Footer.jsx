    ...
    <footer className="w-full bg-gray-100 dark:bg-gray-900 py-16">
      <div className="md:px-12 lg:px-28">
        <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
          <img src={logo} alt="logo tailus" className="m-auto w-11" />
          <ul
            role="list"
            className="flex flex-wrap items-center justify-center py-10 sm:gap-8 gap-4 sm:flex-row mx-3"
          >
            <li role="listitem">
          ...
          <div className="m-auto flex w-max items-center justify-between space-x-4">
            <a href="tel:+999999999999" aria-label="call">
              <svg
          ...
          <div className="text-center">
            <span className="text-sm tracking-wide">
              Copyright © Roomy 2023 <span id="year"></span> | All right
              reserved
            </span>
          </div>
        </div>
